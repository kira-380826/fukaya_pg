            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              <div className="flex items-center bg-[#15181a] p-4 rounded-xl border border-white/5">
                ...
                <div>
                  ...
                  <p className="font-bold text-white text-sm">contact@fukayapg.example.com</p>
                </div>
              </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="join">入部・見学について</option>
              ...
              <div className="pt-4">
                <button 
                  type="button" 
                  className="w-full bg-[#ffd700] hover:bg-white text-[#101415] font-black py-4 px-8 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(255,215,0,0.25)] flex items-center justify-center space-x-3 uppercase tracking-wider text-base group"
                >
                  <span>送信する</span>
